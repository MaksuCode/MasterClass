...
public class LeapYear {
    ...
    public static boolean isLeapYear(int year){
        ...
        boolean isLeapYear ;
        int remainderOf_4 = year % 4 ;
        int remainderOf_100 = year % 100 ;
        int remainderOf_400 = year % 400 ;
        if (remainderOf_4 == 0 && remainderOf_100 == 0 && remainderOf_400 == 0){
            isLeapYear = true ;
        }else if (remainderOf_100 == 0 && remainderOf_400 == 0){
            isLeapYear = true ;
        }else if (remainderOf_400 == 0){
            isLeapYear = true ;
        }else {
            isLeapYear = false ;
        }
